...
guideApplicationSchema.index({ email: 1 }, { unique: true });
guideApplicationSchema.index({ status: 1 });
guideApplicationSchema.index({ status: 1, isActive: 1 });
guideApplicationSchema.index({ destinations: 1 });
guideApplicationSchema.index({ languages: 1 });
guideApplicationSchema.index({ hourlyRate: 1 });
guideApplicationSchema.index({ rating: -1 });
