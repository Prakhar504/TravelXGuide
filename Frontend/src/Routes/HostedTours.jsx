    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 pt-16 sm:pt-20 md:pt-24 pb-6 sm:pb-8 md:pb-12 px-3 sm:px-4 lg:px-8">
      ...
      <div className="relative max-w-6xl mx-auto mb-6 sm:mb-8 md:mb-12 animate-slide-up">
        <div className="relative overflow-hidden rounded-2xl md:rounded-3xl shadow-2xl">
          <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 p-6 sm:p-8 md:p-12 overflow-hidden">
          <div className="absolute inset-0 bg-black/10"></div>
          <div className="relative z-10 text-center">
            <div className="flex justify-center gap-3 mb-4">
              <span className="text-4xl md:text-5xl animate-float">🏔️</span>
              <span className="text-4xl md:text-5xl animate-float" style={{animationDelay: '0.2s'}}>🗺️</span>
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-4 drop-shadow-2xl">
              Discover <span className="bg-gradient-to-r from-yellow-300 to-pink-300 bg-clip-text text-transparent">Amazing Tours</span>
            </h1>
            ...
            <div className="max-w-2xl mx-auto mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 border-2 border-white/30 bg-white/10 backdrop-blur-md rounded-xl focus:ring-2 focus:ring-white focus:border-white text-white placeholder-white/60 text-lg"
                />
                <svg className="absolute right-4 top-1/2 transform -translate-y-1/2 h-6 w-6 text-white/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <select
                ...
                className="px-4 py-2.5 border-2 border-white/30 bg-white/20 backdrop-blur-md text-white rounded-xl focus:ring-2 focus:ring-white font-medium"
              >
